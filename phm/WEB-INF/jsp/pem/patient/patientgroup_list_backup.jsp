...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="patientgroup/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
						<td>
							<span class="input-icon">
								<input autocomplete="off" id="nav-search-input" type="text" name="name" value="${pd.name}" placeholder="团队名称" />
							...
							<tr>
								...
								<td style="width: 40px;">${vs.index+1}</td>
									...
									<%-- 	<td>${var.hospitalId}</td>
										<td>${var.hospitalOfficeId}</td> --%>
										<td>${var.hospitalOfficeName}</td>
										<td>${var.checkCardType}</td>
