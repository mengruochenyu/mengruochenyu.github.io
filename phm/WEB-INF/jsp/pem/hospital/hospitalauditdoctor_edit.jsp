...
<body>
<form action="hospitalauditdoctor/saveHospitalauditdoctor.do" name="editForm" id="editForm" method="post" enctype="multipart/form-data" onsubmit="return save();">
<%-- 	<form action="hospitalauditdoctor/${msg}.do" name="editForm" id="editForm" method="post"> --%>
		<input type="hidden" name="id" id="id" value="${entity.id}"/>
		<div id="zhongxin" style="padding-top:20px;">
		<table id="table_report" class="table noline">
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>医院:</td>
				<td>
