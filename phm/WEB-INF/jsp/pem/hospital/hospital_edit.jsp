...
/* 		if($("#addressProv").val()==""){
		...
		if($("#hospitalPath").val()==""){
			popupTip('hospitalPath', '请输入医生端路径');
			return false;
		}
		if($("#userPath").val()==""){
...
<%-- 	<form action="hospital/${msg}.do" name="editForm" id="editForm" method="post"> --%>
		<form action="hospital/saveHospital.do" name="editForm" id="editForm" method="post" enctype="multipart/form-data" onsubmit="return save();">
		...
		<table id="table_report" class="table noline">
			...
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>医院介绍:</td>
			...
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>医生端路径:</td>
				<td><textarea style="resize: none;width:200px;" name="hospitalPath" id="hospitalPath" placeholder="请输入医生端路径">${entity.hospitalPath}</textarea></td>
			</tr>
			<tr>
