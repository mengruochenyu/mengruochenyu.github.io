...
<script type="text/javascript">
	...
	function save(target){
		...
		var action = '${msg}';
		var url = 'checkpackagesheetasso/' + action;
...
<body>
	<form action="checkpackagesheetasso/${msg}.do" name="editForm" id="editForm" method="post">
		...
		<table id="table_report" class="table noline">
			...
			<tr>
				...
				<td><input type="number" name="seq" id="seq" value="${entity.seq}" maxlength="32" placeholder="请输入序号"/></td>
			</tr>
			<tr>
