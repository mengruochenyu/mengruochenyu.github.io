...
<body>
	<form action="cardentity/${msg}.do" name="editForm" id="editForm" method="post">
		...
		<table id="table_report" class="table noline">
			...
			<tr>
				<td style="width:80px;text-align: right;padding-top: 13px;"><em>*</em>有效期开始时间:</td>
				<td><input type="text" name="validTimeEnd" id="validTimeEnd" value="${entity.validTimeEnd}" maxlength="32" placeholder="请输入有效期结束时间"/></td>
			</tr>
			<tr>
